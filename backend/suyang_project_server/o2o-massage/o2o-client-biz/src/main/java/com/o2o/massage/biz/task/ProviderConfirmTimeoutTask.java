 ...
 * @Description:
 */
public class ProviderConfirmTimeoutTask extends AbstractTask {
    ...
    protected void run() throws Exception {
        List<String> orderNos = orderDao.qryTimeoutOrdersByStatus(OrderStatus.WAIT_PROVIDER_CONFIRM.code());
        for (String orderNo : orderNos) {
            try {
                orderBiz.providerConfirmTimeout(orderNo);
