...
<script>
	...
	var pagefunction = function() {
		...
		loadScript("/static/js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js", function(){
			loadScript("/static/js/plugin/vectormap/jquery-jvectormap-world-mill-en.js", renderVectorMap);
		});

		// pie chart
		loadScript("/static/js/plugin/moment/moment.min.js", function(){
			loadScript("/static/js/plugin/chartjs/chart.min.js", renderPie)});

		//flot chart
		// load all flot plugins
		loadScript("/static/js/plugin/flot/jquery.flot.cust.min.js", function(){
			loadScript("/static/js/plugin/flot/jquery.flot.resize.min.js", function(){
				loadScript("/static/js/plugin/flot/jquery.flot.fillbetween.min.js", function(){
					loadScript("/static/js/plugin/flot/jquery.flot.orderBar.min.js", function(){
						loadScript("/static/js/plugin/flot/jquery.flot.pie.min.js", function(){
							loadScript("/static/js/plugin/flot/jquery.flot.time.min.js", function(){
								loadScript("/static/js/plugin/flot/jquery.flot.tooltip.min.js", [saleschart(), linechart()]);
							});
						});
					});
				});
	...
	var pagedestroy = function(){
		...
		For common instances, such as Jarviswidgets, Google maps, and Datatables, are automatically destroyed through the sys.js loadURL mechanic
